...
public class NetflixServlet extends WebSocketServlet {
    ...
    {
        try {
            excludedWords.addAll(IOUtils.readLines(NetflixServlet.class.getResourceAsStream("excludeGermanWords1000.txt")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
