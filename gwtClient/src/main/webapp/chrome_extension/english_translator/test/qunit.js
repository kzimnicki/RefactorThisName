 ...
 * Pulled Live from Git Sat Apr 14 20:30:01 UTC 2012
...
// addEvent(window, "error" ) gives us a useless event object
    ...
    function done() {
        ...
        var i, key, banner = id("qunit-banner"), tests = id("qunit-tests"), runtime = +new Date() - config.started, passed = config.stats.all - config.stats.bad, html = [
            "Tests completed in ",
            runtime,
            " milliseconds.<br/>",
            "<span class='passed'>",
