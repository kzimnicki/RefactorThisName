   ...
   @UiHandler("save")
    ...
    public native void loadOptions() /*-{
        ...
        $wnd.ajaxExecutor.loadOptions(function(optionsData){
            instance.@com.mySampleApplication.client.OptionsDialog::initOptions(Lcom/google/gwt/core/client/JavaScriptObject;)(optionsData);
        });
    }-*/;
    ...
    public native void saveOptions(String json) /*-{
        ...
        $wnd.ajaxExecutor.saveOptions(json, function(data){
            instance.@com.mySampleApplication.client.OptionsDialog::afterSave()();
        });
    }-*/;
